...
// ------- Prefetching rocket configs ---------------

// Chipyard Config w/ Prefetching
class FireSimPrefetchingRocketConfig extends Config(
  new WithDefaultFireSimBridges ++
  new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
...
class FireSimRocketPrefetchSimple extends Config (
    new WithNIC ++
    new WithDefaultFireSimBridges ++
    new WithDefaultMemModel ++
    new WithFireSimConfigTweaks ++
    new chipyard.RocketPrefetchSimple
)

class FireSimRocketNLSimple extends Config (
    new WithNIC ++
    new WithDefaultFireSimBridges ++
    new WithDefaultMemModel ++
    new WithFireSimConfigTweaks ++
    new chipyard.RocketNLSimple
)

class FireSimRocketPrefetchTemplate extends Config (
    new WithNIC ++
    new WithDefaultFireSimBridges ++
    new WithDefaultMemModel ++
    new WithFireSimConfigTweaks ++
    new chipyard.RocketPrefetchTemplate
)

class FireSimRocketNLPrefetch extends Config(
    new WithNIC ++
    new WithDefaultFireSimBridges ++
    new WithDefaultMemModel ++
    new WithFireSimConfigTweaks ++
    new chipyard.RocketNLPrefetch
)
